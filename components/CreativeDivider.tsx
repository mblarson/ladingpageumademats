  ...
  return (
    <div className="relative w-full h-24 md:h-40 overflow-visible z-30 pointer-events-none">
      ...
      <div className="absolute inset-0 leading-none translate-y-[1px]">
        ...
        <svg className="w-full h-full drop-shadow-[0_-10px_20px_rgba(0,0,0,0.2)]" viewBox="0 0 1440 320" preserveAspectRatio="none">
          <motion.path 
            initial={{ d: "M0,224L48,213.3C96,203,192,181,288,181.3C384,181,480,203,576,224C672,245,768,267,864,261.3C960,256,1056,224,1152,202.7C1248,181,1344,171,1392,165.3L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" }}
            animate={{ 
              d: [
